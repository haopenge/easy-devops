...
import com.easy.devops.api.domain.entity.ProjectEntityExample.Criteria;
import com.easy.devops.api.domain.entity.ProjectEntityExample.Criterion;
import com.easy.devops.api.domain.entity.ProjectEntityExample;
import java.util.List;
import java.util.Map;

public class ProjectEntitySqlProvider {

    public String countByExample(ProjectEntityExample example) {
        BEGIN();
        SELECT("count(*)");
        FROM("easy_project");
    ...
    public String deleteByExample(ProjectEntityExample example) {
        BEGIN();
    ...
    public String insertSelective(ProjectEntity record) {
        BEGIN();
    ...
    public String selectByExample(ProjectEntityExample example) {
        BEGIN();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ProjectEntity record = (ProjectEntity) parameter.get("record");
        ProjectEntityExample example = (ProjectEntityExample) parameter.get("example");
    ...
    public String updateByPrimaryKeySelective(ProjectEntity record) {
        BEGIN();
        UPDATE("easy_project");
    ...
    protected void applyWhere(ProjectEntityExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }

...
echo "<<====================== 1.1 构建docker镜像 ===================>>"
docker build -t registry.cn-hangzhou.aliyuncs.com/ranmo/easy-gray-gateway-api:7 -f Dockerfile .

echo "<<====================== 1.2 登录docker仓库===================>>"
docker login --username=16601114926 --password=270698050qQ registry.cn-hangzhou.aliyuncs.com

echo "<<====================== 1.3 docker镜像 ===================>>"
docker push registry.cn-hangzhou.aliyuncs.com/ranmo/easy-gray-gateway-api:7
